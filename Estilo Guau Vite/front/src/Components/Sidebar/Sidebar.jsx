...
import { HiArrowSmRight, HiChartPie, HiInbox, HiShoppingBag, HiKey, HiUser, HiDocumentText ,HiReceiptTax ,HiTicket   } from "react-icons/hi";
  ...
  <Sidebar.ItemGroup>
    ...
    {idRol === 2 && (
      <>
        ...
        <Link to="/ofertas">
          <Sidebar.Item icon={HiReceiptTax} className='hover:bg-custom'>
            Ofertas
          </Sidebar.Item>
        </Link>

        <Link to="/cupones">
          <Sidebar.Item icon={HiTicket} className='hover:bg-custom'>
            Cupones
          </Sidebar.Item>
        </Link>
    ...
    {idRol === 3 && (
      <>
        ...
        <Link to="/Suscripcion">
          <Sidebar.Item icon={HiKey} className='hover:bg-custom'>
            Suscripciones
          </Sidebar.Item>
        </Link>
      </>
